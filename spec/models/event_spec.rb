...
describe Event do
  context "validations" do
    ...
    context "only one active event per city" do
      When(:invalid_event) { Event.create description: "something", city_id: city.id, active: true}
      ...
      context "allows for other active events in other cities" do
        ...
        When(:valid_event) { Event.create description: "something", city_id: other_city.id, active: true}
